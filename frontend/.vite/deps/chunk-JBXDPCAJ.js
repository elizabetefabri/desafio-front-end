...
function useLoaded({
  ...
  const [loaded, setLoaded] = React5.useState(false);
  React5.useEffect(() => {
    if (!src && !srcSet) {
      return void 0;
    }
...
var Avatar = React5.forwardRef(function Avatar2(inProps, ref) {
  ...
  if (hasImgNotFailing) {
    children = (0, import_jsx_runtime3.jsx)(ImgSlot, _extends({}, imgSlotProps));
  } else if (!!childrenProp || childrenProp === 0) {
    children = childrenProp;
  } else if (hasImg && alt) {
    children = alt[0];
  } else {
    children = (0, import_jsx_runtime3.jsx)(AvatarFallback, {
      ownerState,
      className: classes.fallback
    });
  }
  return (0, import_jsx_runtime3.jsx)(AvatarRoot, _extends({
    as: component,
    ownerState,
...
//# sourceMappingURL=chunk-JBXDPCAJ.js.map
